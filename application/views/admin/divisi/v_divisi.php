            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <a href="<?= base_url('admin/divisi/insert'); ?>"><i class="fas fa-plus"></i> Tambah</a>
                            </div>
                            <div class="col-6 text-right">
                                <a href="<?= base_url('admin/divisi/export_excel'); ?>" class="text-success p-3" title="Export excel"><i class="fas fa-file-export"></i> Excel</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
